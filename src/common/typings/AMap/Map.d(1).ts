declare namespace AMap {
  ...
  export class Map {
    ...
    poiOnAMAP(obj: Record<string, any>): void;

    detailOnAMAP(obj: Record<string, any>): void;
    ...
    add(overlayers: Array<any> | any): void;

    remove(overlayers: Array<any> | any): void;

    getAllOverlays(type: any): Record<string, any>;

    setCenter(position: LngLat | any): void;
    ...
    addControl(obj: Record<string, any>): void;
  ...
  export interface CircleMarkerType {
    center?: LngLat | any;
  ...
  export class CircleMarker {
    constructor(opts: CircleMarkerType);
